...
def main():
    ...
    gen = getattr(models, cfg.models.generator.name)(z_dim=cfg.models.generator.z_dim, norm=cfg.models.generator.norm).to(device)
    dis = getattr(models, cfg.models.discriminator.name)(norm=cfg.models.discriminator.norm, use_sigmoid=cfg.models.discriminator.use_sigmoid).to(device)

    train_dataset = FaceDataset(cfg.train.dataset, cfg.train.target_size)
    ...
    for epoch in range(epochs):
        ...
        for i, batch in enumerate(train_loader):
            ...
            if iteration % cfg.train.preview_interval == 0:
                ...
                save_image((x_real.data.cpu()[:16,:,:,:] + 1.0) * 0.5, os.path.join(out, 'preview', f'real.png')) 
